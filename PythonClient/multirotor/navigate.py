...
while True:
    ...
    if (result == "\0"):
        ...
        # 분할한 영상을 4개의 가로 대역으로 나누고, 각 대역에서 가장 큰 값과 가장 작은 값을 계산한다.
